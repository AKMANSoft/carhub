...
function AboutDropdown() {
    ...
    return (
        <Menu as="div" className="relative inline-block text-left">
            ...
            >
                <Menu.Items className="absolute right-0 z-10 mt-2 w-56 overflow-clip origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <Menu.Item>
                        {({ active }) => (
    ...
    return (
        <Menu as="div" className="relative inline-block text-left">
            ...
            <Transition
                ...
                leaveTo="transform opacity-0 scale-95"
            >
                <Menu.Items className="absolute z-10 right-0 mt-2 w-56 overflow-clip origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div>
                        {
