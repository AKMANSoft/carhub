...
export default function SigninPopup() {
    ...
    return (
        <BasePopup popupRef={popupRef}>
            {/* Trigger Button  */}
            <button type='button' id='trigger' className='text-sm md:text-base font-medium text-gray-500 px-2 md:px-3 hover:text-primary py-2 md:py-3 rounded-full'>
                Sign In
            </button>
            {/* Popup Content  */}
            <div className="max-w-2xl bg-primary-image w-full text-white py-14 px-5 md:px-20 rounded-lg min-h-screen md:min-h-[700px] relative">
